#ifndef VECTORIX__CUSTOM_VECTORIZER_H
#define VECTORIX__CUSTOM_VECTORIZER_H
...
public:
	static v_image vectorize(const pnm_image &image, params &parameters); // Run vectorization
private:
