...
void v_line::add_point(v_pt &&_p_control_next, v_pt &&_control_prev, v_pt &&_main, v_co &&_color, p _width = 1) {
	segment.back().control_next = _p_control_next;
...
void v_line::add_point(v_pt &&_main, v_co &&_color, p _width = 1) {
