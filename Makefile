...
OBJS = main.o v_image.o export_svg.o pnm_handler.o vectorizer.o render.o potrace_handler.o custom_vectorizer.o opencv_render.o parameters.o exporter_ps.o exporter.o geom.o offset.o least_squares.o
DEBUG = -ggdb
